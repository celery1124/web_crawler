...
/***  Acknowledgment   ***/
/*
* From sample code HTMLParserTest
*
*/
...
#ifdef _WIN64
#ifdef _DEBUG
#pragma comment (lib, "src/HTMLParser_lib/HTMLParser_debug_x64.lib")
#else
#pragma comment (lib, "src/HTMLParser_lib/HTMLParser_release_x64.lib")
#endif
#else
#ifdef _DEBUG
#pragma comment (lib, "src/HTMLPhaser_lib/HTMLParser_debug_win32.lib")
#else
#pragma comment (lib, "src/HTMLPhaser_lib/HTMLParser_release_win32.lib")
#endif
#endif
